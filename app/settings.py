...
SECRET_KEY = 'django-insecure-=%v$b49#@s0yw6*n%(eg=aw1m50&ftvv27d27!e@ezgkt@-_^_'
...
INSTALLED_APPS = [
    ...
    'allauth.socialaccount.providers.facebook',  # Provedor do Facebook
    'django_extensions',
    'rifa',
    'pagamento',
    'usuario',
...
SOCIALACCOUNT_PROVIDERS = {
    'facebook': {
        'APP': {
            'client_id': '1456256091920752',
            'secret': '12788dd107bb150c655b80db2d148678',
            'key': ''
        },
        'METHOD': 'oauth2',
